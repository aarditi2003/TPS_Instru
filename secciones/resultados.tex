...
El ensayo de consumo de corriente sirve para saber cuánta corriente le pide a la red el equipo bajo prueba. El equipo médico se enchufa al receptáculo de prueba del ESA612, que queda intercalado entre la red y el dispositivo y mide la corriente que circula por esas conexiones. 
    La escala se selecciona en amperes. 

El valor por sí solo no dice demasiado: lo que le da sentido es compararlo con el consumo que declara el fabricante en el manual del equipo o en la etiqueta. Si el consumo medido resulta bastante mayor que el declarado puede haber un problema en la fuente de alimentación, 
    aislaciones degradadas o algún componente en falla, y si resulta mucho menor puede ser que alguna etapa del equipo no esté funcionando. Conocer el consumo real también permite verificar que la instalación y las protecciones del sector estén bien dimensionadas, 
    algo que importa en un ambiente clínico donde varios equipos comparten la misma línea.
