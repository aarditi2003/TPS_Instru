...
\begin{table}[H]
    ...
    Una principal fuente de error, el cual luego se propagó a lo largo de la práctica, fue la medición de la temperatura ambiente, la cual fue de 24 °C cuando debería haber rondado los 19 °C. Consideramos que esto podría deberse a que se sostuvo el termopar con la mano, transfiriéndole calor a los cables de conexión y aumentando así la temperatura registrada. A su vez, la conexión con 
    el tester era inestable, ya que había que ubicarlo manualmente para que ambas terminales estuvieran en contacto y pudiera medir. Incluso, moviendo el dispositivo el registro variaba considerablemente, y sumado al error intrínseco del multímetro, provoca grandes incertezas. Por otro lado,
