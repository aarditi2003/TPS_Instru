...
\subsection{Medición de resistencia a tierra}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figuras/Resistencia/Resistencia_a_Tierra.png}
    \caption{Medición de la resistencia entre la tierra de protección y la tierra del dispositivo.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figuras/Fuga/PE.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figuras/Fuga/Entre_PAs.png}
...
\begin{figure}[H]
    ...
    \caption{Ensayo de corriente de fuga de la carcasa.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figuras/Aislamiento/PA_a_Neutro.png}
    \caption{Ensayo de resistencia de aislamiento entre parte aplicada y neutro.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figuras/Aislamiento/Fase_a_Tierra.png}
    \caption{Ensayo de resistencia de aislamiento entre la tierra de prorección y fase.}
